...
namespace FalseTerrarianTest.Projectile
{
	public class ExampleLastPrismBeam : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Terraria.Projectile hostPrism = Main.projectile[(int)HostPrismIndex];
		...
		private float PerformBeamHitscan(Terraria.Projectile prism, bool fullCharge)
		{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			// Draw the outer beam.
			DrawBeam(texture, startPosition, endPosition, drawScale, GetOuterBeamColor() * OuterBeamOpacityMultiplier * Projectile.Opacity);
